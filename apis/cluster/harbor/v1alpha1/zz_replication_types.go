...
type ReplicationInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-upjet-harbor/apis/cluster/harbor/v1alpha1.Registry
	...
	// (Boolean), prevent parallel runs under the same replication. (Default: false)
